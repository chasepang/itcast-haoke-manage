...
-- 初始数据
INSERT INTO `tb_estate` ( `id`, `name`, `province`, `city`, `area`, `address`, `year`, `type`, `property_cost`, `property_company`, `developers`, `created`, `updated` )
VALUES
...
`payment_method` TINYINT ( 1 ) DEFAULT NULL COMMENT '支付方式，1-付一押一，2-付三押一，3-
付六押一，4-年付押一，5-其它',
...
`time` TINYINT ( 1 ) DEFAULT NULL COMMENT '看房时间，1-上午，2-中午，3-下午，4-晚上，5-全
天',
`property_cost` VARCHAR ( 10 ) DEFAULT NULL COMMENT '物业费',
